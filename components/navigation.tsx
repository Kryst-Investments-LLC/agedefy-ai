...
const navigation = [
  ...
  { name: "Biomarker Tracking", href: "/biomarker-tracking", icon: TrendingUp, badge: "Advanced" },
  { name: "Genomic Analysis", href: "/genomic-analysis", icon: Search, badge: "Genetic" },
  { name: "Personalized Medicine", href: "/personalized-medicine", icon: Stethoscope, badge: "Custom" },
  { name: "Disease Prevention", href: "/disease-prevention", icon: Shield, badge: "AI" },
  { name: "Learning System", href: "/learning-system", icon: BookOpen, badge: "ML" },
  { name: "VR/AR Education", href: "/vr-ar-education", icon: Calendar, badge: "VR" },
  { name: "Blockchain Security", href: "/blockchain-security", icon: Shield, badge: "Web3" },
  { name: "IoT Integration", href: "/iot-integration", icon: Server, badge: "IoT" },
  { name: "Mental Health", href: "/mental-health", icon: Brain, badge: "AI" },
  { name: "Sustainability", href: "/sustainability", icon: BookOpen, badge: "Green" },
  { name: "User Content", href: "/user-content", icon: Users, badge: "Social" },
  { name: "Gamification", href: "/gamification", icon: TrendingUp, badge: "Game" },
  { name: "Health Records", href: "/health-records", icon: TestTube, badge: "EHR" },
  { name: "Data Visualization", href: "/data-visualization", icon: BarChart3, badge: "Analytics" },
