...
const navigation = [
  ...
  { name: "Lab Testing", href: "/lab-testing", icon: Microscope, badge: "Premium" },
  { name: "Clinical Trials", href: "/clinical-trials", icon: Calendar, badge: "Premium" },
  { name: "AI Personalization", href: "/personalization", icon: Brain, badge: "Premium" },
]
