  ...
  return (
    <AppShell>
      ...
      <main className="max-w-3xl mx-auto px-4 py-12">
        <h1 className="text-3xl font-bold text-foreground mb-8">Help Center</h1>
        ...
        <div className="space-y-6 text-muted-foreground text-sm">
          <section className="space-y-4">
            ...
            <div className="space-y-3">
              <details className="bg-card/50 border border-border rounded-lg">
                <summary className="p-4 cursor-pointer text-foreground hover:text-teal-400">How do I create an account?</summary>
              ...
              <details className="bg-card/50 border border-border rounded-lg">
                <summary className="p-4 cursor-pointer text-foreground hover:text-teal-400">How do I reset my password?</summary>
                <div className="px-4 pb-4 text-muted-foreground">
                  Go to the <Link href="/forgot-password" className="text-teal-600 dark:text-teal-400 hover:underline">forgot password page</Link>{" "}
                  and enter your email. You&apos;ll receive a reset link valid for 1 hour.
                </div>
              </details>

              <details className="bg-card/50 border border-border rounded-lg">
                <summary className="p-4 cursor-pointer text-foreground hover:text-teal-400">What data can I track?</summary>
                <div className="px-4 pb-4 text-muted-foreground">
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-3">
              <details className="bg-card/50 border border-border rounded-lg">
                <summary className="p-4 cursor-pointer text-foreground hover:text-teal-400">Compound Mixer</summary>
                <div className="px-4 pb-4 text-muted-foreground">
              ...
              <details className="bg-card/50 border border-border rounded-lg">
                <summary className="p-4 cursor-pointer text-foreground hover:text-teal-400">Research & Clinical Trials</summary>
                <div className="px-4 pb-4 text-muted-foreground">
              ...
              <details className="bg-card/50 border border-border rounded-lg">
                <summary className="p-4 cursor-pointer text-foreground hover:text-teal-400">Subscriptions & Billing</summary>
                <div className="px-4 pb-4 text-muted-foreground">
                  ...
                  Visit <Link href="/pricing" className="text-teal-600 dark:text-teal-400 hover:underline">Pricing</Link> to compare plans.
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-3">
              <details className="bg-card/50 border border-border rounded-lg">
                <summary className="p-4 cursor-pointer text-foreground hover:text-teal-400">How do I export my data?</summary>
                <div className="px-4 pb-4 text-muted-foreground">
                  Go to your <Link href="/account" className="text-teal-600 dark:text-teal-400 hover:underline">Account page</Link> and
                  use the &ldquo;Export Data&rdquo; button. This downloads all your data as a JSON file immediately.
                </div>
              </details>

              <details className="bg-card/50 border border-border rounded-lg">
                <summary className="p-4 cursor-pointer text-foreground hover:text-teal-400">How do I delete my account?</summary>
                <div className="px-4 pb-4 text-muted-foreground">
