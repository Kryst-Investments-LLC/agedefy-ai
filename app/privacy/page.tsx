    ...
    <AppShell>
      ...
      <main className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-invert prose-gray max-w-none space-y-6 text-muted-foreground text-sm leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mt-8 mb-3">1. Data We Collect</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mt-8 mb-3">3. Sensitive Health Data</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mt-8 mb-3">4. Service Providers &amp; Sharing</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mt-8 mb-3">7. Your Rights (GDPR / UK GDPR)</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mt-8 mb-3">8. California Privacy Rights (CCPA/CPRA)</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mt-8 mb-3">9. International Data Transfers</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mt-8 mb-3">11. Cookies</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mt-8 mb-3">12. Changes to This Policy</h2>
