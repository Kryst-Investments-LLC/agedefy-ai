  ...
  return (
    <AppShell>
      ...
      <main className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-invert prose-gray max-w-none space-y-6 text-muted-foreground text-sm leading-relaxed">
          <p className="text-muted-foreground">Last updated: June 2026</p>

          <section>
            <h2 className="text-xl font-semibold text-foreground mt-8 mb-3">1. Acceptance</h2>
            <p>By accessing or using Biozephyra, you agree to be bound by these Terms of Service and our <a href="/privacy" className="text-teal-600 dark:text-teal-400 hover:underline">Privacy Policy</a> and <a href="/disclaimer" className="text-teal-600 dark:text-teal-400 hover:underline">Medical Disclaimer</a>. If you do not agree, do not use the platform.</p>
          </section>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mt-8 mb-3">3. Description of Service</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mt-8 mb-3">6. Subscriptions &amp; Billing</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mt-8 mb-3">7. Third-Party Services</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mt-8 mb-3">12. Termination</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mt-8 mb-3">13. Governing Law &amp; Dispute Resolution</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mt-8 mb-3">14. Changes</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mt-8 mb-3">15. Severability &amp; Entire Agreement</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mt-8 mb-3">16. Contact</h2>
