  ...
  return (
    <AppShell>
      ...
      <main className="max-w-3xl mx-auto px-4 py-12">
        <h1 className="text-3xl font-bold text-foreground mb-8">Safety Guidelines</h1>
        ...
        <div className="prose prose-invert prose-gray max-w-none space-y-6 text-muted-foreground text-sm leading-relaxed">
          <div className="bg-red-900/20 border border-red-800 rounded-lg p-4 mb-8">
            <p className="text-red-700 dark:text-red-300 font-semibold text-base">Health & Safety First</p>
            <p className="text-red-700 dark:text-red-200/80 mt-1">
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mt-8 mb-3">1. Always Consult a Professional</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mt-8 mb-3">2. Check Interactions</h2>
            <p>
              Use the Compound Mixer to check for known interactions before combining compounds.
              Pay special attention to <strong className="text-red-600 dark:text-red-400">DANGEROUS</strong> and{" "}
              <strong className="text-yellow-600 dark:text-yellow-400">CAUTION</strong> severity ratings. Our database is not exhaustive —
              absence of a listed interaction does not guarantee safety.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-foreground mt-8 mb-3">3. Start Low, Go Slow</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mt-8 mb-3">4. Track Everything</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mt-8 mb-3">5. Community Guidelines</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mt-8 mb-3">6. AI Limitations</h2>
            <p>
